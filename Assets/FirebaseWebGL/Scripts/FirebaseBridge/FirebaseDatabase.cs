...
namespace FirebaseWebGL.Scripts.FirebaseBridge
{
    public static class FirebaseDatabase
    {
        ...
        [DllImport("__Internal")]
        public static extern void PostCurrentScore(string path, int value3, /*string objectName,*/ string callback,
            string fallback);

        [DllImport("__Internal")]
        public static extern void PostTotalScore(string path, int value4, string value5, /*string objectName,*/ string callback,
            string fallback);
